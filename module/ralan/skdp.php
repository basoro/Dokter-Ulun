...
<div class="row clearfix">
  <div class="col-md-3">
    <div class="form-group">
      <div class="form-line">
        <dt>Diagnosa</dt>
        <dd><input type="text" class="form-control" name="dx" required></dd>
      </div>
    </div>
  </div>
  <div class="col-md-3">
    <div class="form-group">
      <div class="form-line">
        <dt>Alasan</dt>
        <dd><input type="text" class="form-control" name="alasan" required></dd>
      </div>
    </div>
  </div>
  <div class="col-md-3">
    <div class="form-group">
      <div class="form-line">
        <dt>No SKDP</dt>
        <dd><div id="antri" class="antri" name="noan"></div>
        </dd>
      </div>
    </div>
  </div>
  <div class="col-md-3">
    <div class="form-group">
      <div class="form-line">
        <dt>No Reg</dt>
        <dd><dd><input type='text' id='noreg' class='form-control' name='noreg' placeholder='No Registrasi' required></dd>
      </div></dd>
    </div>
  </div>
</div>
<div class="row clearfix">
  <div class="col-md-3">
    <div class="form-group">
      <div class="form-line">
        <dt>Tindak Lanjut</dt>
        <dd><input type="text" class="form-control" name="tlj" required></dd>
      </div>
    </div>
  </div>
  <div class="col-md-3">
    <div class="form-group">
      <div class="form-line">
        <dt>Terapi</dt>
        <dd><input type="text" class="form-control" name="terapi" required></dd>
      </div>
    </div>
  </div>
  <div class="col-md-3">
...
<div class="row clearfix">
  <table id="booking" class="table responsive striped">
    <tr>
      <th>No</th>
