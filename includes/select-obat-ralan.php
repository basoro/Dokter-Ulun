...
$sql = query("select databarang.kode_brng AS id, databarang.nama_brng AS text, gudangbarang.stok AS jumlah from databarang inner join gudangbarang on databarang.kode_brng=gudangbarang.kode_brng where databarang.status='1' and gudangbarang.kd_bangsal='B0014' AND gudangbarang.stok > 0 AND (databarang.kode_brng LIKE '%".$q."%' OR databarang.nama_brng LIKE '%".$q."%') group by databarang.nama_brng order by databarang.nama_brng");
