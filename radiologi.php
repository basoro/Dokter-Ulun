...
if(isset($_GET['no_rawat'])) {
    $_sql = "SELECT a.no_rkm_medis, a.no_rawat, b.nm_pasien, b.umur, a.status_lanjut , a.kd_pj, GROUP_CONCAT(DISTINCT d.nm_perawatan SEPARATOR '<br>') AS nm_perawatan FROM reg_periksa a, pasien b, periksa_radiologi c, jns_perawatan_radiologi d WHERE a.no_rkm_medis = b.no_rkm_medis AND a.no_rawat = '$_GET[no_rawat]' AND a.no_rawat = c.no_rawat AND c.kd_jenis_prw = d.kd_jenis_prw GROUP BY a.no_rawat";
      ...
      <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="card">
            ...
            <div class="body">
			  <dt>Intepretasi Hasil</dt><br>
              <dd>
                <?php
                $sql_rad = fetch_assoc(query("select * from hasil_radiologi where no_rawat= '{$_GET['no_rawat']}'"));
                echo nl2br($sql_rad['hasil']);
                ?>
              </dd>
            </div>
            <div class="body">
                <?php
                $sql = fetch_assoc(query("select * from saran_kesan_rad where no_rawat= '{$_GET['no_rawat']}'"));
                ?>
			  <dt>Kesan</dt>
              <dd>
                <?php
            ...
            <div class="body">
              ...
              ?>
                <form method="POST" action="">
                  ...
                  <dt>Input Intepretasi</dt><br>
                  <dd><textarea rows="6" id="tinymce" name="hasil" class="form-control no-resize" placeholder="Tulis catatan hasil disini..."></textarea></dd><br>
                  <dt>Kesan</dt><br>
