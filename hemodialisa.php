                ...
                <div class="tab-content m-t-20">
                  <div role="tabpanel" class="tab-pane fade in active" id="poli">
                    <table id="datatable_ralan" class="table table-bordered table-striped table-hover display nowrap">
                      ...
                      <tbody>
                        <?php
                          $_sql = "SELECT b.nm_pasien, c.nm_dokter, a.no_reg, a.no_rkm_medis, a.no_rawat, a.stts FROM reg_periksa a, pasien b, dokter c WHERE a.kd_poli = 'U0019' AND a.no_rkm_medis = b.no_rkm_medis AND a.kd_dokter = c.kd_dokter";
              ...
              <div class="tab-content m-t-20">
                ...
                <!-- skdp -->
                  <div role="tabpanel" class="tab-pane fade" id="skdp">
                    <?php include_once ('./module/skdp-hd.php');?>
                  </div>
                <!-- end skdp -->
              </div>
              <!-- Tab Panes -->
